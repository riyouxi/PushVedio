...
Java_com_test_push_media_PublishJni_init(JNIEnv *env, jclass type, jstring url_, jint w, jint h,
                                         jint timeOut) {
...
Java_com_test_push_media_PublishJni_sendSpsAndPps(JNIEnv *env, jclass type, jlong cptr,
...
JNIEXPORT jint JNICALL
Java_com_test_push_media_PublishJni_sendVideoData(JNIEnv *env, jclass type, jlong cptr,
...
JNIEXPORT jint JNICALL
Java_com_test_push_media_PublishJni_sendAacSpec(JNIEnv *env, jclass type, jlong cptr,
...
JNIEXPORT jint JNICALL
Java_com_test_push_media_PublishJni_sendAacData(JNIEnv *env, jclass type, jlong cptr,
                                                jbyteArray data_, jint len, jlong timestamp) {
    jbyte *data = env->GetByteArrayElements(data_, NULL);
...
JNIEXPORT jint JNICALL
Java_com_test_push_media_PublishJni_stop(JNIEnv *env, jclass type, jlong cptr) {
    Rtmp *rtmp = reinterpret_cast<Rtmp *> (cptr);
    delete rtmp;
    return 0;
}
